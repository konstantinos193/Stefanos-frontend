...
Also, we pledge to never push directly to `main`. That is not a social contract — that is an engineering one.
...
- Gracefully accepting constructive criticism (even when it is about your CSS)
- Focusing on what is best for the community and the codebase
- Showing empathy towards other community members
- Writing meaningful commit messages (no, "fix stuff" does not count)
...
- Committing `node_modules` to the repository
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project team at **conduct@smholdings.gr**. All complaints will be reviewed and investigated promptly and fairly.
