...
export const MobileHeroSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-black to-gray-900 min-h-[100vh] min-h-[100dvh] flex items-start justify-center overflow-hidden md:hidden pt-16">
      ...
      <div className="relative w-full px-4 pt-6 pb-8">
        <div className="flex flex-col items-center text-center w-full space-y-3">
          ...
          <div className="w-full mb-1">
            <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2 leading-tight px-2">
              {t('hero.title')}
              <span className="block text-[#d4af37] mt-1">{t('hero.titleHighlight')}</span>
            </h1>
            <p className="text-xs sm:text-sm text-gray-200 mb-3 max-w-xs mx-auto leading-relaxed px-2">
              {t('hero.description')}
            </p>
          </div>
