...
export const RecentAdditionsSection = ({ properties }: RecentAdditionsSectionProps) => {
  ...
  const defaultProperties: Property[] = [
    {
      id: '1',
      title: 'Beachfront Apartment in Preveza',
      location: 'Preveza, Greece',
      price: 120,
      rating: 4.8,
      image: 'https://placehold.co/400x300/3b82f6/FFFFFF?text=Preveza+Beachfront',
    ...
    {
      id: '2',
      title: 'Luxury Villa Near Preveza Port',
      location: 'Preveza, Greece',
      price: 350,
      rating: 4.9,
      image: 'https://placehold.co/400x300/10b981/FFFFFF?text=Preveza+Villa',
    ...
    {
      id: '3',
      title: 'Cozy Studio in Preveza Center',
      location: 'Preveza, Greece',
      price: 80,
      rating: 4.7,
      image: 'https://placehold.co/400x300/f59e0b/FFFFFF?text=Preveza+Studio',
    ...
    {
      id: '4',
      title: 'Modern Condo in Preveza',
      location: 'Preveza, Greece',
      price: 280,
      rating: 4.9,
      image: 'https://placehold.co/400x300/ef4444/FFFFFF?text=Preveza+Condo',
